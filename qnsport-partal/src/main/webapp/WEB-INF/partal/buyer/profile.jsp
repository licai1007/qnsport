		...
		<div class="confirm">
			...
			<div class="ofc">
				...
				<form id="jvForm" action="profile.do" method="post">
					...
					<li>
						<label for="jsutilsidence">居 住 地：</label>
						<span class="word">
					...
					<li><label for="addjsutilss">详细地址：</label>
						<span class="bg_text"><input type="text" id="addjsutilss" name="addjsutilss" maxLength="32" value="北京海滨区XXXXXXX"/></span>
