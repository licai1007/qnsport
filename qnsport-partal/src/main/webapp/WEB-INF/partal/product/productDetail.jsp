...
function changeSize(obj,size){
	...
	function buy(){
		window.location.href = "/cart/shopping.html?skuId="+gSkuId+"&amount="+$('#num').val()+"&url="+encodeURIComponent(window.location.href);
	}
		...
		<ul class="uls form">
			...
			<li><label>选择颜色：</label>
				<div id="colors" class="pre spec">
					...
					<a onclick="changeColor(this,'${color.id}')" href="javascript:void(0)" title="${color.name}" class="changToWhite"><img width="25" height="25" data-img="1" src="/jsutils/img/pic/ppp00.jpg" alt="${color.name} "><i>${color.name}</i></a>
					</c:forEach>
				</div>
			</li>
