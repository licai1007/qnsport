	...
	$("#tabs a").each(function(){
		...
		$(this).click(function(){
			...
			if(ref == '#tab_2'){
				...
				fck.Height = 400 ;
				//设置上传路径
				fck.Config["ImageUploadURL"] = "/upload/productDesc.do"
				//把数据同步到 textarea
				fck.ReplaceTextarea();
			}
		});
...
$(function(){
	$('#clear').click(function(){
		...
		$('#himg').val("");
		var content = FCKeditorAPI.GetInstance("productdesc"); 
...
<div class="body-box" style="float:right">
	<form id="pForm" action="/product/save.do" method="post" enctype="multipart/form-data">
			...
			<tbody>
				<tr>
					<td class="pn-fbutton" colspan="2">
						...
						<input type="reset" id="clear" class="submit" value="重置"/>
					</td>
				</tr>
			</tbody>
		</table>
